...
resource "aws_route_table" "dove-rt" {
  vpc_id = aws_vpc.dove.id
...
resource "aws_route_table_association" "dove-rt-a-1" {
  subnet_id      = aws_subnet.dove-pub-1.id
  route_table_id = aws_route_table.dove-rt.id
}
resource "aws_route_table_association" "dove-rt-a-2" {
  subnet_id      = aws_subnet.dove-pub-2.id
  route_table_id = aws_route_table.dove-rt.id
}
resource "aws_route_table_association" "dove-rt-a-3" {
